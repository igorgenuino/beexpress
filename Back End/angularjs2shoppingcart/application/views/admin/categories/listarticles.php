                ...
                <table id="example1"
                  ...
                  <thead>
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="example1"
                        ...
                        style="width: 154px;"><?php echo lang('admin_photo')?></th>
                  ...
                  <tbody>
                    ...
                    <tr role="row" class="even">
                      ...
                      <td><a href="<?php echo site_url('admin/articles/delete/'.$item->id)?>" onclick="return confirm('Are you sure?')"><?php echo lang('admin_delete')?></a> | 
                          <a href="<?php echo site_url('admin/articles/update/'.$item->id)?>"><?php echo lang('admin_edit')?></a> | 
                          <a href="<?php echo site_url('admin/articles/findByArticle/'.$item->id)?>"><?php echo lang('admin_lists')?></a>
                      </td>
                    </tr>
                    <?php }?>
                  </tbody>
